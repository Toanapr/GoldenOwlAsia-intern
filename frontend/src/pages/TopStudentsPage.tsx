...
const podiumStyles = {
  1: { className: "bg-amber-50 text-amber-700 ring-amber-200", icon: Trophy },
    ...
    <Card className="overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full min-w-[680px] border-collapse text-left text-sm">
          ...
          <thead className="sticky top-0 z-10 bg-slate-50 text-xs font-bold tracking-wide text-slate-500 uppercase">
            <tr>
          ...
          <tbody className="divide-y divide-slate-100">
            {students.map((student) => (
              ...
              >
                ...
                <td className="px-5 py-4 text-right text-base font-extrabold tabular-nums text-brand-700">
